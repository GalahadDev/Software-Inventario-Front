...
import { Pedido } from "app/types";
import { DollarSign, CreditCard, Truck, Package, MapPin, ClipboardList } from "lucide-react";
// Agregamos la importación del helper para convertir la fecha a horario de Chile
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                {/* Fecha (convertida a horario de Chile) */}
                <div className="flex items-center">
                  <MapPin className="w-5 h-5 mr-3 text-gray-500" />
                  <p className="text-gray-600">
                    {toChileDate(new Date(pedido.FechaCreacion)).toLocaleDateString("es-ES")}
                  </p>
                </div>
              </div>
            </div>
